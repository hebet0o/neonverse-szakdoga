    ...
    return (
        <div className="home-container">
            ...
            <div className="content">
                ...
                <model-viewer camera-controls auto-rotate rotation-per-second="30deg" touch-action="pan-y" autoplay ar ar-modes="webxr scene-viewer" scale="0.2 0.2 0.2" camera-target="0m 0.20m 0m" shadow-intensity="2" src="assets/models/mainmodel_low.glb" alt="Main 3D model"></model-viewer>
            </div>
        </div>
    );
};
